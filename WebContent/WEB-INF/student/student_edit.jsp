			...
			<form action="<%=path %>/StudentServlet" name="form1" method="post">
			    <input type="hidden" value="${empty param.id ?"add":"update"}" name="action"/>
			      ...
			      <input type="hidden" value="${student.id}" name="id">
				     <table width="28%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
						<tr bgcolor="#EEF4EA">
					        <td colspan="3" background="<%=path %>/img/wbg.gif" class='title'><span>${empty param.id ?"添加":"修改"}学生信息</span></td>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="stuno" value="${student.stuno }" size="20"/>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						       <select class="INPUT_text" name="sex">
							    <option value="男" selected="selected">请选择性别</option>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						     <button type="button" onclick="check1();" >${empty param.id ?"确认添加":"确认修改"}</button>
						       ...
						       <button onclick="'StudentServlet?action=list'">返回</button>
